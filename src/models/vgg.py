...
__all__ = [
    'VGG', 'vgg7_bn', 'vgg9', 'vgg11', 'vgg11_bn', 'vgg12_bn', 'vgg13', 'vgg13_bn', 'vgg16', 'vgg16_bn',
    'vgg19_bn', 'vgg19',
]
...
cfg = {
    ...
    'G': [64, 'M', 128, 'M', 256, 'M', 512, 'M'],
    'H': [64, 'M', 128, 'M', 256, 256, 'M', 256, 256, 'M', 512, 512, 512, 'M'],
}

def vgg7_bn(num_classes=10):
    """VGG 7-layer model (configuration "A")"""
    return VGGLight(make_layers(cfg['G'], batch_norm=True), num_classes)
...
def vgg12_bn(num_classes=10):
    """VGG 11-layer model (configuration "A") with batch normalization"""
    return VGG(make_layers(cfg['H'], batch_norm=True), num_classes)
