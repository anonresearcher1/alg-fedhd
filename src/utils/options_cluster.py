...
def args_parser():
    ...
    parser.add_argument('--distill_wd', type=float, default=0.0, help="Distillation weight decay")
    ...
    parser.add_argument('--a', type=float, default=0.5, help="Self-Teaching Temperature")
    parser.add_argument(
        "--adaptive_weight_T",
        nargs="+",
        type=float,
